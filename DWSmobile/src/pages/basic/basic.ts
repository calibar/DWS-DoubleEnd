...
this.couverinfo.Phototime=localStorage.getItem('PhotoedTime')*/
  ...
  getPos(){
    ...
    .then(pos=>{
      ...
      this.loader.dismiss();
      this.basicinfo.Lat=pos[0].toFixed(6)
      this.basicinfo.Lon=pos[1].toFixed(6)
      console.log(this.basicinfo.Lat)
      console.log(this.basicinfo.Lon)
    })
  }
  getlatlon(){
    this.getPreciseLocation()
  ...
  takePicture(){
    ...
    const options: CameraOptions = {
      ...
      this.camera.getPicture(options).then((imageData) => {
        ...
        // If it's base64:
        this.basicinfo.Uploader=localStorage.getItem('CurrentUser')
        this.basicinfo.Pic=imageData;
